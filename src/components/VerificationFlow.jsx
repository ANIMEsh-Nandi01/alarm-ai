...
export default function VerificationFlow({ referencePhotos, onVerified, onFail }) {
    ...
    useEffect(() => {
        async function analyze() {
            ...
            // Use the hardcoded key from service
            const result = await verifyEnvironment(referencePhotos, capturedImages);
    ...
    }, [step, referencePhotos, capturedImages, onVerified, onFail]);
